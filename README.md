...
The repository includes a reusable Playwright setup under `tests/e2e` for validating rendered pages and user interactions generated by QingKuai components.
