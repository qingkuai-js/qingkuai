...
export function IntantiateComponentManually(): never {
    typeError(
        "You can not intantiate the component manually because this process requires some state generated by compiler."
    )
}
