...
export const FRAGMENT_ROOT = 1 << 0
export const FRAG_WITH_TARGET = 1 << 1
export const FRAG_WHOLE_CONTENT = 1 << 2
export const FRAG_LEADING_ANCHOR = 1 << 3
export const FRAG_ORPHAN_CONTENT = 1 << 4
